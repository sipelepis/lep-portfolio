...
export class MultiItemCarouselComponent {
  ...
  ngOnInit(): void {
    this.projects=[
      ...
      { img: ['assets/projects/ecotreasure-proj-comp1.png', 'assets/projects/ecotreasure-proj-comp2.png'], title: 'EcoTreasure - A Waste Management app', tech: 'Figma, Adobe Photoshop and Adobe Illustrator', caption: ' We designed the UI/UX of a project proposal for an Ideathon, Smart 4.0.',url: 'https://www.figma.com/file/rCcuw7dx8oLF4tB1A7Ukbr/EcoTreasure?type=design&node-id=211%3A2&mode=design&t=chbALBZXw0M5sC3I-1', alt: "Photo of EcoTreasure"},
      { img: ['assets/projects/gusi-proj-1.png','assets/projects/gusi-proj-2.png','assets/projects/gusi-proj-3.png','assets/projects/gusi-proj-4.png'], title: 'GUSI - A Digital Repository for a College at UE-Caloocan', tech: 'Angular 14+, Ubuntu 22.04, DSpace, Google Analytics, Figma and PostgreSQL', caption: 'We built a digital repository website using DSpace.',url: 'https://github.com/sipelepis/gusi-ga', alt: "Photo of GUSI"},
      { img: ['assets/projects/relayver2-proj-1.png','assets/projects/relayver2-proj-2.png','assets/projects/relayver2-proj-3.png'], title: 'Relay Version 2', tech: 'Angular 14+, MDBootstrap, figma and @angular/pwa', caption: 'We developed a responsive web application with PWA using Figma and Angular.',url: 'https://github.com/sipelepis/relay-v2', alt: "Photo of Relay Version 2"},
      { img: ['assets/projects/idyip-proj-comp-1.png', 'assets/projects/idyip-proj-comp-2.png'], title: 'iDyip - A Mobile Based Fare Collection System', tech: 'Android Studio, Java, Cloud Firetstore, Android SDK and XML', caption: 'We are developing a mobile based fare collection system using Java.',url: 'https://github.com/sipelepis/iDyip', alt: "Photo of iDyip"},
      { img: ['assets/projects/hotel-de-flora-proj-1.png', 'assets/projects/hotel-de-flora-proj-2.png', 'assets/projects/hotel-de-flora-proj-3.png'], title: 'Hotel de Flora - Hotel Management System', tech: 'C#, XAMPP', caption: 'We developed a Hotel Management System using C# and XAMPP.', url: 'https://github.com/sipelepis/CSharp_HotelReservationSystem', alt: "Photo of Hotel De Flora"},
